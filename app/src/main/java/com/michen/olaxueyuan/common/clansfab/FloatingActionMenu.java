...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsTextSize = attr.getDimension(R.styleable.FloatingActionMenu_menu_labels_textSize, getResources().getDimension(R.dimen.sp_12));
...
//            mIcon = getResources().getDrawable(R.drawable.fab_add);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mIcon = getResources().getDrawable(R.drawable.common_blue, null);
            } else {
                mIcon = getResources().getDrawable(R.drawable.common_blue);
            }
        }
    ...
    private void createMenuButton() {
        ...
        mMenuButton.setText("发布作业");
//        mMenuButton.setTextColor(getResources().getColor(Color.WHITE));
        mMenuButton.setTextColor(ColorStateList.valueOf(Color.WHITE));
        mMenuButton.setTextSize(12);
        mMenuButton.setGravity(Gravity.CENTER);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (label != null) {
                ...
                int labelUsedWidth = (int) (child.getMeasuredWidth() + label.calculateShadowWidth() + mLabelsMargin + labelOffset);
