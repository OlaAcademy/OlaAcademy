...
//	}
     ...
     * @param content
     */
    public static void copText(Context mContext, String content) {
        ClipboardManager clipboardManager = (ClipboardManager) SEAPP.getAppContext().getSystemService(Context.CLIPBOARD_SERVICE);
//        clipboardManager.setText(content);
        clipboardManager.setPrimaryClip(ClipData.newPlainText(null, content));
        ToastUtil.showToastShort(mContext, "已复制到粘贴板");
    }
}
