...
public class CircleProgressBar extends ProgressBar {
    ...
    private final Paint mProgressTextPaint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mStyle = a.getInt(R.styleable.CircleProgressBar_style_circle, LINE);
    ...
    private void initPaint() {
        ...
        mProgressTextPaint2.setTextAlign(Paint.Align.CENTER);
        mProgressTextPaint2.setTextSize(mProgressTextSize);
