...
public class NoScrollThreeGridAdapter extends BaseAdapter {
    ...
    public NoScrollThreeGridAdapter(Context ctx, ArrayList<String> urls) {
        this.ctx = ctx;
        this.imageUrls = urls;
    }

    public NoScrollThreeGridAdapter(Context ctx, ArrayList<String> urls, int type) {
        this.ctx = ctx;
        this.imageUrls = urls;
        this.type = type;
    }
    ...
    public int getCount() {
        if (imageUrls == null) {
            ...
            return imageUrls.size() > 3 ? 3 : imageUrls.size();
        }
    }
