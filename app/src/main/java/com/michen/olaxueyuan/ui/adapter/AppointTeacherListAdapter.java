...
public class AppointTeacherListAdapter extends BaseAdapter {
    Context context;
    List<AppointTeacherListResult.ResultBean> list = new ArrayList<>();

    public AppointTeacherListAdapter(Context context) {
        this.context = context;
    }

    public void updateData(List<AppointTeacherListResult.ResultBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.appoint_teacher_list_item, null);
