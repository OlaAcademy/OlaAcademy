...
public class TGetSubjectListViewAdapter extends BaseAdapter {
    ...
    public TGetSubjectListViewAdapter(Context mContext) {
...
//        }
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mContext.startActivity(new Intent(mContext, TSubjectListActivity.class)
                        .putExtra("type", 2).putExtra("objectId", mDatas.get(position).getId()));
            }
        });
        return convertView;
    }
