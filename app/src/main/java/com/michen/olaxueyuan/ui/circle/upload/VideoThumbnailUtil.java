...
/**
 * Created by LIJIAN on 2016/1/27.
 */
public class VideoThumbnailUtil {
    ...
    public static Intent filterIntentByType(Context context, Intent targetIntent) {
        PackageManager pm = context.getPackageManager();
        //所有安装的应用(包括已卸载的但目录还存在的)
        List<ResolveInfo> resolveInfos = pm.queryIntentActivities(targetIntent, PackageManager.MATCH_DEFAULT_ONLY);
