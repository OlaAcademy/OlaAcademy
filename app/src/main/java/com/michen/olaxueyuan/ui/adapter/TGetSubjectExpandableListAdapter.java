 ...
 */
public class TGetSubjectExpandableListAdapter extends BaseExpandableListAdapter {
    Context context;
    ...
    public TGetSubjectExpandableListAdapter(Context context) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.startActivity(new Intent(context, TSubjectListActivity.class)
                        .putExtra("type", 1).putExtra("objectId", courseId));
            }
        });
        return convertView;
    }
