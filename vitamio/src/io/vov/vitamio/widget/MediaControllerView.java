...
public class MediaControllerView extends FrameLayout implements View.OnClickListener {
    ...
    private RelativeLayout full_screen_title_layout;
...
//            android.util.Log.e("===", "============");
    ...
    public MediaControllerView(Context context, View view) {
        super(context);
        this.mView = view;
    ...
    public MediaControllerView(Context context, View view, View rootView) {
        super(context);
        this.mView = view;
    ...
    public MediaControllerView(Context context, Activity activity, View view, View rootView, boolean isAuthen, Authentication authentication) {
        super(context);
    ...
    public MediaControllerView(Context context, Activity activity, View view, View rootView) {
        super(context);
        this.activity = activity;
        this.mView = view;
        this.rootView = rootView;
...
//        return ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("mediacontroller", "layout", mContext.getPackageName()), this);
    ...
    private void initControllerView(View v) {
        ...
        full_screen_title_layout = (RelativeLayout) v.findViewById(getResources().getIdentifier("full_screen_title_layout", "id", mContext.getPackageName()));
        list_layout = (LinearLayout) v.findViewById(getResources().getIdentifier("list_layout", "id", mContext.getPackageName()));
        ...
        if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
            ...
            if (mFromXml) {
                ...
                if (activity.getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
                    full_screen_title_layout.setVisibility(VISIBLE);
                } else {
                    full_screen_title_layout.setVisibility(GONE);
                }
...
//                Log.d("MediaController already removed");
    ...
    public interface Authentication {
        void isFiveMinute(boolean isAuth,boolean flag);
    }
...
//                list_layout.setVisibility(GONE);
            } else {
                hide();
            }
            return true;
