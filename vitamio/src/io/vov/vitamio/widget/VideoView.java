 ...
 */
public class VideoView extends SurfaceView implements MediaControllerView.MediaPlayerControl {
...
//                setVideoLayout(mVideoLayout, mAspectRatio);
    ...
    public MediaControllerView mMediaController;
    ...
    private OnErrorListener mErrorListener = new OnErrorListener() {
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                videoPlayFailListener.videoPlayFaile(true);
...
//      return;
    ...
    public void setMediaController(MediaControllerView controller) {
        if (mMediaController != null)
            mMediaController.hide();
