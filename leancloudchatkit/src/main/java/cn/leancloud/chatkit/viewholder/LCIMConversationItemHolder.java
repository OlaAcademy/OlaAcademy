...
public class LCIMConversationItemHolder extends LCIMCommonViewHolder {
    ...
    public void bindData(Object o) {
        ...
        if (null != conversation) {
            ...
            Log.e("----------", "conversation=" + conversation.getMembers().toString() + ":" + conversation.getConversationId() + ":" + conversation.getName()
                    + ":" + conversation.get("peerId") + ":" + conversation.get("fromPeerId"));
...
//            updateIcon(conversation);
    ...
    private void updateName(AVIMConversation conversation) {
        Log.e("----------", "conversation=" + conversation.getMembers().toString());
       /* LCIMProfileCache.getInstance().getCachedUsers(conversation.getMembers(), new AVCallback<List<LCChatKitUser>>() {
            ...
            protected void internalDone0(List<LCChatKitUser> lcimUserProfiles, AVException e) {
                ...
                nameView.setText(TextUtils.join(",", nameList));
            }
        });*/
        ...
        if (null != conversation) {
                    ...
                    protected void internalDone0(String s, AVException e) {
                        ...
                        if (!TextUtils.isEmpty(s)) {
                            Picasso.with(getContext()).load(s)
                                    ...
                                    .error(R.drawable.lcim_default_avatar_icon).into(avatarView);
                        } else {
           ...
           /* LCIMProfileCache.getInstance().getCachedUsers(conversation.getMembers(), new AVCallback<List<LCChatKitUser>>() {
                ...
                protected void internalDone0(List<LCChatKitUser> lcimUserProfiles, AVException e) {
                    ...
                    if (null != lcimUserProfiles) {
                        for (LCChatKitUser userProfile : lcimUserProfiles) {
                            avatarList.add(userProfile.getAvatarUrl());
                        }
                    }
//                    Picasso.with(getContext()).load(avatarList.get(0))
